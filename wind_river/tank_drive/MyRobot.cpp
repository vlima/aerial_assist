...
class RobotDemo: public IterativeRobot
{
   ...
   Joystick m_driveStick2; // Joystick object on USB port 1 (mecanum drive)
   Gyro m_gyro;
   Encoder m_encoder;
...
public:
   RobotDemo() :
      // Create a RobotDrive object using PWMS 1, 2, 3, and 4
            m_robotDrive(1, 2, 3, 4), m_driveStick(1), m_driveStick2(2), m_gyro(1), m_encoder(1, 2)
   {
   }
   ...
   {
      m_robotDrive.TankDrive(m_driveStick.GetY(), m_driveStick2.GetY());
